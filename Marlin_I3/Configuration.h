...
#define Z_HOMING_HEIGHT 18       // (in mm) Raise Z before homing (G28) for Probe Clearance.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100,100,400,138}  // default steps per unit for Ultimaker
